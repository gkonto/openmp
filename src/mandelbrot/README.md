# Mandlebrot Area calculation

Each folder contains a variation of Mandelbrot Area calculation.
To run tests and compare their output, follow the instructions below:

NOTE:
> The two variations (sequential, c1) are not comparable since the code is different!
